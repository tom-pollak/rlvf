...
for i in range(10):
    ...
    print(f"Sample {i}: {analysis['num_grids']} grids, markers {analysis['markers_found']}")
...
# %%
def create_llm_prompt(input_ids: List[int], mask_last_grid: bool = True) -> Tuple[str, str]:
    """
